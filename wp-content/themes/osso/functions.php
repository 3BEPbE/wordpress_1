<?php
/**
 * osso functions and definitions
 *
...
if ( ! function_exists( 'osso_setup' ) ) :
	...
	function osso_setup() {
		 ...
		 * If you're building a theme based on osso, use a find and replace
		 * to change 'osso' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'osso', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'osso' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'osso_custom_background_args', array(
...
add_action( 'after_setup_theme', 'osso_setup' );
 ...
 */
function osso_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'osso_content_width', 640 );
}
add_action( 'after_setup_theme', 'osso_content_width', 0 );
 ...
 */
function osso_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'osso' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'osso' ),
...
add_action( 'widgets_init', 'osso_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'osso_scripts' );
